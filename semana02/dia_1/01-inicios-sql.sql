...
\ l -- Cambiamos a la base de datos que queremos utilizar
\ c pruebas -- \! sirve para poder ejecutar cualquier comando del sistema operativo dentro del psql
-- cls en windows es para limpiar la terminal
-- clear en mac es para limpiar la terminal
\ ! cls CREATE TABLE personas (
    id SERIAL PRIMARY KEY,
    nombre TEXT NOT NULL,
    apellido TEXT,
    correo TEXT UNIQUE,
    -- El correo jamas se va a repetir
...
VALUES (
        ...
        'Sebastian',
        null,
        'sebas.aguero1107@gmail.com',
        '2003-11-07'
    );
INSERT INTO personas (nombre, apellido, correo, fecha_nacimiento)
VALUES (
        'Eduardo',
        null,
